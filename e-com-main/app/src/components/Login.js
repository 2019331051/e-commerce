...
function Login() {
  ...
  return (
    <Stack
      ...
      sx={{ width: "100%",
       maxWidth: "700px" ,
       background: "linear-gradient(to bottom,#E8E8E8, #FFFFff)", // Navy blue gradient
       marginTop: "20px", // Add the desired margin value
      //  color: "black";
      borderRadius:"7%",

      }}
    >
      <Typography variant="h2" align="center" fontWeight="semi-bold" color="black" 
      >
